...
const Mint = () => {
  ...
  const mintToken = async (price, tokenName) => {
    const userPubKey = account.startsWith("k:") ? account.slice(2) : account;

    let caps = [];
    caps.push(
      Pact.lang.mkCap("Coin Transfer", `${tokenName} fee`, "coin.TRANSFER", [
        account,
        DOC_ACCOUNT,
        price,
      ])
      ...
      <div className={styles.mint}>
        ...
        {isMinting ? (
          <div className="row d-flex justify-content-center text-center py-5">
            <Spinner animation="border" role="status">
              <span className="visually-hidden">{mintStatus}</span>
            </Spinner>
            <p className="pt-4">{mintStatus}</p>
          </div>
        ) : (
          <div className="row">
            <div className="col-md-5" style={{ padding: "44px" }}>
              <video
              ...
              <div style={{ textAlign: "center", marginTop: "26px" }}>
                <button
                  onClick={() => mintNFT("mintit-creator-access-pass")}
            ...
            <div className="col-md-5 offset-2" style={{ padding: "44px" }}>
