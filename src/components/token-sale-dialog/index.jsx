...
import { toggleTokenSaleDialog } from "../../store/token.module";
import { ZELCORE } from "../../constants/kadena";

const TokenSaleDialog = () => {
    const dispatch = useDispatch();
    const show = useSelector((state) => state.token.isTokenSaleDialog);
    const current = useSelector((state) => state.token.current);
    ...
    return (
        ...
        >
            <Modal.Body>
                ...
                ) : current && account == current["current-owner"] ? (
                    <>
                        <h3 className="mb-5">
                            Selling,{" "}
                            <span style={{ color: "#20ec8d" }}>
                            ...
                            <div className="col-12">
                                ...
                                >
                                    <input
                                        type="number"
                                        step="0.1"
                                        placeholder="Enter Token Sale Price in KDA"
                                        value={price}
                                        onChange={(e) => {
...
export default TokenSaleDialog;
